...
try {
    ...
    match ($route) {
        ...
        'auth.social' => (new AuthController())->social(),
        'lang.set' => (new AuthController())->language(),
        ...
        'attempts.export' => (new AttemptController())->export(),

        'rankings.index' => (new RankingController())->index(),
