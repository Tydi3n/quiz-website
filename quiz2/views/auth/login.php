<section class="auth-shell">
    ...
    <form class="panel form-stack" method="post" action="<?= e(route_url('auth.login')) ?>">
        ...
        <div class="social-login">
            ...
            <a class="button ghost wide" href="<?= e(route_url('auth.social', ['provider' => 'google'])) ?>">Google demo</a>
            <a class="button ghost wide" href="<?= e(route_url('auth.social', ['provider' => 'github'])) ?>">GitHub demo</a>
        </div>
